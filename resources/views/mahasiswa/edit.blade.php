            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-0" style="border-radius: 15px;">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
                        ...
                        <a href="{{ route('mahasiswa.index') }}" class="btn btn-secondary btn-sm rounded-pill px-3">Kembali</a>
                    </div>
                    ...
                    <form action="{{ route('mahasiswa.update', $mahasiswa->id_mahasiswa ?? $mahasiswa->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <a href="{{ route('mahasiswa.index') }}" class="btn btn-outline-secondary ms-2 rounded-pill px-4">Batal</a>
                        </div>
                    </form>
